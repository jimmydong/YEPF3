...
about.addEventListener('click', function(){
    message.innerHTML = 'YEPF Debug原本设计应用在FirePHP基础上，因FireBug停止维护，改进为ChromeLogger兼容模式。请打开DevTools选择console并选中server标签，以便查看结果。<font color=red>注意：修改设定后请刷新页面两次</font>';
