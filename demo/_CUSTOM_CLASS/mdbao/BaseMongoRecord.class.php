...
//fix by jimmy.dong@gmail.com 注意： 数值 + null = NaN。必须保证数字累加。
...
//连接mongodb xwarrior @2012/7/20
    function connect_mongodb()
    {
        ...
        BaseMongoRecord::$connection = new \MongoClient('mongodb://'.$GLOBALS['mongodb_config']['host']);
        BaseMongoRecord::$database = $GLOBALS['mongodb_config']['database'];
        //启用从库读
        BaseMongoRecord::$connection->setReadPreference( Mongo::RP_SECONDARY_PREFERRED );  //by jimmy.dong@gmail.com ??? Deprecated: Function Mongo::setSlaveOkay() is deprecated
